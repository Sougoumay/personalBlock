...
Route::group(['prefix'=>'customer'], function(){
    Route::get('/viewArticle/{id}',[VisitorController::class,'viewArticle'])
        ->name('customer.viewArticle')->where(['id'=>'[0-9]+']);
    Route::get('/allArticle',[VisitorController::class,'allArticle'])->name('customer.allArticle');
    Route::get('/homePage',[VisitorController::class,'homePage'])->name('customer.homePages');
});

Route::view('/layouts','layouts.main_layouts');

Route::view('/customerLayouts','layouts.customerLayouts');
